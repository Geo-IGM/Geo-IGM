...
def main():
    ...
    parser = argparse.ArgumentParser(description="Geological Map Interactive Viewer")
    parser.add_argument("--img", default=DEFAULT_IMG_PATH, help="Original geological map image path")
    parser.add_argument("--regions", default=DEFAULT_JSON_PATH, help="Region JSON file path")
